...
@Component({
  selector: 'app-rimuovereprogettista-progettistiteam',
  templateUrl: './rimuovereprogettista-progettistiteam.component.html',
  styleUrls: ['./rimuovereprogettista-progettistiteam.component.sass']
})
export class RimuovereprogettistaProgettistiteamComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.progettistaService.getProgettistiTeamPP(this.selectedId,this.pp[1],this.pp[0])
