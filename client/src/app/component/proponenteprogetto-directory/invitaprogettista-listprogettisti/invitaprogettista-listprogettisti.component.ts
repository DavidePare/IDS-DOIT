...
@Component({
  selector: 'app-invitaprogettista-listprogettisti',
  templateUrl: './invitaprogettista-listprogettisti.component.html',
  styleUrls: ['./invitaprogettista-listprogettisti.component.sass']
})
export class InvitaprogettistaListprogettistiComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.progettistaService.getProgettistiPPinvite(this.selectedId,this.pp[1],this.pp[0])
